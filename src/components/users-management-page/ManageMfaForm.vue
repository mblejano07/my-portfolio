    ...
    <div class="flex w-full flex-col gap-2 pb-4">
      ...
      <template v-if="!mfaOptionsAreLoading">
        <button
          ...
          :class="`mb-1 mt-3 flex items-center justify-between rounded-lg px-2 py-2 font-bold ring-2 transition-all hover:scale-[101%] sm:px-6 sm:py-4 ${payload.mfa_step === option.name ? 'ring-primary-500' : 'ring-surface-500'}`"
        >
