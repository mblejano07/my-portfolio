...
<template>
  <MainDialog as="div" class="relative z-20" :open="props.isOpen" :initial-focus="focusableEl">
    <div class="bg-surface-900 bg-opacity-90 dark:bg-opacity-80 fixed inset-0 backdrop-blur-sm" aria-hidden="true" />
      ...
      <DialogPanel class="w-full max-w-md">
        <DialogTitle class="rounded-xl px-6 py-10 text-center text-xl tracking-widest md:text-2xl">
          <font-awesome-icon
            ...
            class="text-surface-0 dark:text-primary-500 h-8 animate-spin md:h-12"
          ></font-awesome-icon>
          <br />
          <span class="font-menu text-surface-0 dark:text-primary-500 text-xl font-bold md:text-2xl"
