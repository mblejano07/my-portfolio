...
<template>
  <div class="relative flex min-h-screen">
    ...
    <div class="flex min-w-0 flex-auto flex-col items-center lg:flex-row">
      ...
      <div
        :class="`h-full w-full bg-gradient-to-b from-primary-500 to-primary-900 p-8 transition-all duration-500 dark:from-primary-900 dark:to-primary-950 sm:w-auto md:rounded-none lg:flex lg:h-full lg:items-center lg:justify-center lg:bg-gradient-to-b lg:from-surface-0 lg:to-surface-0 lg:p-10 dark:lg:from-surface-950 dark:lg:to-surface-950 xl:p-14 ${showLogin ? 'md:w-[100%] md:px-16 lg:w-[40%]' : 'md:w-[100%] md:px-16 lg:w-[60%]'}`"
      >
        <!-- Start Login Form -->
        <transition
