export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Plain Button
      { 'text-surface-0 bg-gray-500 ring-1 ring-gray-500': props.plain && !props.outlined && !props.text },
      // Plain Text Button
      ...
      // Secondary Button
      {
        'text-surface-0 dark:text-surface-900': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
      ...
      // Success Button
      {
        'text-surface-0 dark:text-success-900': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
      ...
      // Info Button
      {
        'text-surface-0 dark:text-surface-900': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
      ...
      // Warning Button
      {
        'text-surface-0 dark:text-surface-900': props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
        'bg-warn-500 dark:bg-warn-400': props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
        'ring-1 ring-warn-500 dark:ring-warn-400': props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
      },
      // Warning Text Button
      { 'text-warn-500 dark:text-warn-400': props.text && props.severity === 'warning' && !props.plain },
      // Warning Outlined Button
      {
        'text-warn-500 ring-1 ring-warn-500 hover:bg-warn-300/20': props.outlined && props.severity === 'warning' && !props.plain,
      },

      // Help Button
      {
        'text-surface-0 dark:text-surface-900': props.severity === 'help' && !props.text && !props.outlined && !props.plain,
      ...
      // Danger Button
      {
        'text-surface-0 dark:text-error-900': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
        'bg-error-500 dark:bg-error-400': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
      ...
      {
        'text-error-500 ring-1 ring-error-500 hover:bg-error-300/20':
      ...
      // Plain
      { 'hover:bg-surface-600 hover:ring-surface-600': props.plain && !props.outlined && !props.text },
      ...
      // Warning
      {
        'hover:bg-warn-600 dark:hover:bg-warn-300 hover:ring-warn-600 dark:hover:ring-warn-300':
          props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
      },
      { 'focus:ring-warn-500 dark:focus:ring-warn-400': props.severity === 'warning' },
      // Text & Outlined Button
      { 'hover:bg-warn-300/20': (props.text || props.outlined) && props.severity === 'warning' && !props.plain },
      ...
      // Danger
      {
        'hover:bg-error-600 dark:hover:bg-error-300 hover:ring-error-600 dark:hover:ring-error-300':
          props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
      },
      { 'focus:ring-error-500 dark:focus:ring-error-400': props.severity === 'danger' },
      // Text & Outlined Button
      { 'hover:bg-error-300/20': (props.text || props.outlined) && props.severity === 'danger' && !props.plain },
